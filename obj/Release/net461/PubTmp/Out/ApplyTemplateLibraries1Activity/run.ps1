...
try
{
    ...
    {   Write-Host "Site Found"
        Invoke-PnPSiteTemplate -Path "D:\home\site\WorkBenchTemplate\Libraries1.xml"
        ...
        $siterequest = Set-PnPListItem -List $siterequestlist -Identity $siterequestitemID -Values @{"ProvisioningStage" = "Libraries Template Applied"}
    }
    return $name
}
catch
