...
try
{
    ...
    {   
        ...
        Invoke-PnPSiteTemplate -Path "D:\home\site\WorkBenchTemplate\mastersite.xml"  -ResourceFolder "D:\home\site\WorkBenchTemplate\" -Handlers SiteSecurity,SiteSettings,ApplicationLifecycleManagement,Features,RegionalSettings,SearchSettings   
